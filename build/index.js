...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsApp = __webpack_require__(350);
	
	var _viewsApp2 = _interopRequireDefault(_viewsApp);
	
	_reactDom2['default'].render(_react2['default'].createElement(_viewsApp2['default'], null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(351)['default'];
	
	var _inherits = __webpack_require__(367)['default'];
	
	var _createClass = __webpack_require__(376)['default'];
	
	var _classCallCheck = __webpack_require__(379)['default'];
	...
	var targetCellWidth = 10;
	var targetCellHeight = 10;
	...
	var colorMatrix = new _ColorMatrix2['default'](90, 160);
	...
	var App = (function (_Component) {
	    ...
	    function App() {
	        ...
	        this.onResize = (0, _lodashFunctionThrottle2['default'])(this.onResize.bind(this), 100);
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleClick() {
	            ...
	            var wasPaused = this.state.isPaused;
	        ...
	        value: function handleMouseMove(event) {
	            var _getRelativeCoordinates = getRelativeCoordinates(event);
	
	            var x = _getRelativeCoordinates.x;
	            var y = _getRelativeCoordinates.y;
	            var innerWidth = window.innerWidth;
	            var innerHeight = window.innerHeight;
	
	            colorMatrix.kColor = (0, _utilMap2['default'])(x, 0, innerWidth, 0, 1);
	            colorMatrix.kSpace = (0, _utilMap2['default'])(y, 0, innerHeight, 0, 1);
	        }
	    }, {
	        key: 'togglePause',
	        value: function togglePause() {
	            ...
	            this.setState({ isPaused: !wasPaused }, function () {
	                // if animation was paused at the time of the click event
	                // (it wont be anymore when this is callback is executed)
	                if (wasPaused) {
	                    // kick off animation loop
	        ...
	        value: function render() {
	            ...
	            var wasClicked = _state.wasClicked;
	            var isPaused = _state.isPaused;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(352)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(360)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
	  return function getOwnPropertyDescriptor(it, key){
	    return $getOwnPropertyDescriptor(toIObject(it), key);
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// most Object methods by ES6 should accept primitives
	var $export = __webpack_require__(361)
	  , core    = __webpack_require__(363)
	  , fails   = __webpack_require__(366);
	module.exports = function(KEY, exec){
	  var fn  = (core.Object || {})[KEY] || Object[KEY]
	    , exp = {};
	  exp[KEY] = exec(fn);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(362)
	  , core      = __webpack_require__(363)
	  , ctx       = __webpack_require__(364)
	  , PROTOTYPE = 'prototype';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(368)["default"];
	
	var _Object$setPrototypeOf = __webpack_require__(370)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(363).Object.setPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Works with __proto__ only. Old v8 can't work with null proto objects.
	/* eslint-disable no-proto */
	var getDesc  = __webpack_require__(354).getDesc
	  , isObject = __webpack_require__(374)
	  , anObject = __webpack_require__(375);
	var check = function(O, proto){
	  anObject(O);
	  if(!isObject(proto) && proto !== null)throw TypeError(proto + ": can't set as prototype!");
	};
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(364)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
	        buggy = !(test instanceof Array);
	      } catch(e){ buggy = true; }
	      return function setPrototypeOf(O, proto){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(377)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debounce = __webpack_require__(382),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNative = __webpack_require__(386);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilColor = __webpack_require__(390);
	
	var _utilColor2 = _interopRequireDefault(_utilColor);
	
	var _utilMod = __webpack_require__(394);
	
	var _utilMod2 = _interopRequireDefault(_utilMod);
	...
	var ColorBoard = (function () {
	    ...
	    _createClass(ColorBoard, [{
	        ...
	        value: function randomize() {
	            ...
	            for (var i = 0; i < this._rows; i++) {
	                ...
	                for (var j = 0; j < this._cols; j++) {
	                    this._matrix[i][j] = _utilColor2['default'].random();
	                }
	            }
	        }
	        ...
	        value: function next() {
	            ...
	            this._matrix = this._matrix.map(function (row, i) {
	                return row.map(function (color, j) {
	                    return _this.nextAt(i, j);
	                });
	            });
	        ...
	        value: function at(i, j) {
	            ...
	            return this._matrix[(0, _utilMod2['default'])(i, this._rows)][(0, _utilMod2['default'])(j, this._cols)];
	        }
	        ...
	        value: function nextAt(i, j) {
	            ...
	            if (i < 0 || i >= this._rows || Math.floor(i) !== i || j < 0 || j >= this._cols || Math.floor(j) !== j) {
	                throw new Error('expected integers in [0, ' + this._rows + ') and [0, ' + this._cols + '],' + (' got: ' + i + ', ' + j));
	            }
	
	            // current color at given coordinates
	            var color = this._matrix[i][j];
	            // infinitesimal change in color caused by color
	            var dcColor = color
	            // cross with small vector in first octant
	            .cross(_utilColor2['default'].randomComponentsBetween(0, 2))
	            ...
	            var dcSpace = color.scale(-4).plus(this.at(i + 1, j)).plus(this.at(i - 1, j)).plus(this.at(i, j + 1)).plus(this.at(i, j - 1))
	        ...
	        key: 'renderTo',
	        value: function renderTo(context) {
	            ...
	            var cellWidth = Math.ceil(width / this._cols);
	            var cellHeight = Math.ceil(height / this._rows);
	
	            // clear the canvas
	            context.clearRect(0, 0, width, height);
	
	            this._matrix.forEach(function (row, i) {
	        ...
	        set: function set(rows) {
	            ...
	            if (rows < this._rows) {
	                ...
	                // otherwise desired number of rows is greater than current number of rows
	                    ...
	                    var m = Math.floor(rows / this._rows);
	                    // extra left over after fitting m described above
	                    var n = rows - m * this._rows;
	        ...
	        set: function set(cols) {
	            ...
	            if (cols < this._cols) {
	                ...
	                this._matrix = this._matrix.map(function (row) {
	                ...
	                // otherwise desired number of cols is greater than current number of cols
	                    ...
	                    (function () {
	                        ...
	                        var m = Math.floor(cols / _this2._cols);
	                        // extra left over after fitting m described above
	                        var n = cols - m * _this2._cols;
	
	                        // map each row to the new cycled row
	                        _this2._matrix = _this2._matrix.map(function (row) {
	                            var newRow = row;
	                            // recycle the entire original row m - 1 times
	                            for (var k = 0; k < m - 1; k++) {
	                                newRow = newRow.concat(newRow.slice(0, _this2._cols));
	                            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Number$isFinite = __webpack_require__(391)["default"];
	...
	var Color = (function () {
	    _createClass(Color, null, [{
	        ...
	        value: function random() {
	            return new Color(Math.round(255 * Math.random()), Math.round(255 * Math.random()), Math.round(255 * Math.random()));
	        }
	        ...
	        key: "randomComponentsBetween",
	        value: function randomComponentsBetween(min, max) {
	            var scale = max - min;
	
	            return new Color(scale * Math.random() + min, scale * Math.random() + min, scale * Math.random() + min);
	        }
	    }]);
	    ...
	    function Color(r, g, b) {
	        ...
	        if (!(_Number$isFinite(r) && _Number$isFinite(g) && _Number$isFinite(b))) {
	            throw new TypeError();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(363).Number.isFinite;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 20.1.2.2 Number.isFinite(number)
	var $export   = __webpack_require__(361)
	  , _isFinite = __webpack_require__(362).isFinite;
...
/***/ function(module, exports) {
	...
	exports["default"] = function (x, xMin, xMax, yMin, yMax) {
